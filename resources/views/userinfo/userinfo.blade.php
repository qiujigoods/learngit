...
<!-- Favicons
================================================== -->
<link rel="shortcut icon" href="user_info/images/favicon.png">
<link rel="apple-touch-icon" href="user_info/images/apple-touch-icon.png">
<link rel="apple-touch-icon" sizes="72x72" href="user_info/images/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="114x114" href="user_info/images/apple-touch-icon-114x114.png">
...
<!--stylesheets
====================================================-->
<link rel="stylesheet" type="text/css" href="user_info/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="user_info/css/font-awesome.min.css">  
<link rel="stylesheet" type="text/css" href="user_info/css/style.css">
<link rel="stylesheet" type="text/css" href="user_info/css/simpletextrotator.css"> 

<!--[if lt IE 9]>
	<script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
<![endif]--> 
<script src="user_info/js/jquery.min.js"></script> <!-- JQUERY -->
</head>
<body>
...
<div id="frontpage"> 
	...
	<img src="user_info/images/front-image.jpg" class="front-img img-responsive" alt ="Front-image"><!--IMAGE FOR FRONT SCREEN-->
	<h1>My <span class="invert">Profile</span></h1><!--PROFILE NAME-->
	...
	<div class="frontclick"><img src="user_info/images/click.png" alt="" class="img-responsive"><span class="pulse"></span></div>
</div>
	...
	<div id="content" class="row hidden">
		<div class="col-sm-4">
			...
			<div id="namecard" class="namecard">
				<div class="shadow-img"></div>
				<h1 class="maintitle">My <span class="invert">Profile</span></h1><!--PROFILE NAME-->
				<h3 class="invert sub-maintitle">Web 
					<span class="rotate">Developer, Designer, Artist</span><!--SUBTITLE AFTET NAME-->
				</h3>
				<img id="profile-img" class="profile-img transparent" src="<?php echo $v->head_ico; ?>" alt="profile-image"><!--PROFILE IMAGE-->
			</div><!--/#namecard-->
			<?php endforeach ?>
			<!--menu-->
			...
			<ul class="page-container no-padding">
				...
				<li id="home" class="selected">
					...
					<div class="description hidden">
						...
						<ul class="personal-info">
							<li class="rotate-out rotated"><label>Name</label><span><?php echo $v->true_name; ?></span></li>                     
							<li class="rotate-out rotated"><label>Address</label><span><?php echo $v->contact_addr; ?></span></li>
							<li class="rotate-out rotated"><label>Email</label><span><?php echo $v->email; ?></span></li>  
							<li class="rotate-out rotated"><label>Phone</label><span><?php echo $v->telephone; ?></span></li>
							<li class="rotate-out rotated"><label>QQ</label><span><?php echo $v->qq; ?></span></li>
							<li class="rotate-out rotated"><label>sex</label><span><?php echo $v->sex==1?"男":"女"; ?></span></li>
							<li class="rotate-out rotated"><label>生日</label><span><?php echo $v->birthday; ?></span></li>
						</ul><!--/ul.personal-info-->
						<?php endforeach ?>
					</div>
				</li><!--/#home-->
				...
				<li id="resume" class="hidden">
					<div class="title-container">
						<div class="shadow-img"></div>
						<h2 class="rotate-out rotated"><span class="invert">MY </span> ORDERS</h2> <!--RESUME TITLE-->
					</div>
					<div class="description">
						...
						<div class='tabs tabs_animate'>
							...
							<ul class='horizontal no-padding'>
								<li><a href="#tab-1" class="icon-bg icon-skills"><div>已付订单</div></a></li>
								<li><a href="#tab-2" class="icon-bg icon-education"><div>未付订单</div></a></li>
								<li><a href="#tab-3" class="icon-bg icon-employment"><div>我的购物车</div></a></li>
							</ul><!--RESUME TAB LISTS ENDS-->

							<!--RESUME FIRST TAB/SKILL TAB DETAILS-->
							<div id='tab-1'>
								<h3 class="title">PAY ORDER</h3><!--SKILLS WITH BAR DISPLAY-->

								<ul class="education-class">
								@foreach ($pay_order as $user)
									<li>
										<!--EDUCATION LIST ITEM-->
										<h4 class="title">{{ $user->goods_name }}<i class="fa fa-sort-desc pull-right"></i></h4>
										<div class="list-content">
											<h5 class="title">{{ $user->order_no }} <span class="list-year">下单时间：({{ $user->create_time }})</span></h5>
											<p>备注：{{ $user->postscript }}</p><!--EDUCATION LIST DETAILS-->
										</div>
									</li>
								@endforeach 
								</ul>
							...
							<div id='tab-3'>
								<h3 class="title">GO SHOPPING</h3>
								<ul class="employment-class tab-cont">
								@foreach ($shopping as $user)
									<li>
										<!--EMPLOYMENT INDIVIDUAL LIST-->
										<h4>{{ $user->goods_name }} <span class="year">{{ $user->create_time }}</span></h4>
										<h5>${{ $user->sell_price }}</h5>
										<p>{{ $user->s_content }}</p><!--EMPLOYMENT LIST DETAILS-->
									</li>
									@endforeach 
								</ul>
				...
				<li id="portfolio" class="hidden">
					<div class="title-container">
						<div class="shadow-img"></div>
						<h2 class="rotate-out rotated">COLLECT </h2> <!--PORTFOLIO TITLE-->                         
					</div>
							...
							<div class="folio-container">
								<ul class="folio-item"><!--PORTFOLIO INDIVIDAUAL ITEM-->
									...
									<li class="view view-first photography">  
										<img src="{{ $user->img }}" alt="logs" /><!--PORTFOLIO INDIVIDAUAL ITEM IMAGE--> 
										<div class="mask">  
											 <h2>{{ $user->goods_name }}</h2> <!--PORTFOLIO INDIVIDAUAL ITEM TITLE-->                               
											<!-- Button trigger modal -->
											<a role="button" class="info" data-toggle="modal" data-target="#myModal{{ $user->id }}">Read More</a><!--PORTFOLIO INDIVIDAUAL ITEM MODAL LINK BY 'data-target'-->
										 </div>  
									</li> 
									@endforeach
									...
									<!-- <li class="view view-second commercial">PORTFOLIO INDIVIDAUAL ITEM
									               <img src="user_info/images/folio/book.jpg" alt="book" />PORTFOLIO INDIVIDAUAL ITEM IMAGE 
									             	<div class="mask"></div>
									             	<div class="content">
									             ...
									             <li class="view view-tenth photography"> PORTFOLIO INDIVIDAUAL ITEM 
									             	 <img src="user_info/images/folio/beach.jpg" alt="beach" /> PORTFOLIO INDIVIDAUAL ITEM IMAGE  
									             	 <div class="mask">  
									             ...
									             <li class="view view-second commercial">PORTFOLIO INDIVIDAUAL ITEM
									               <img src="user_info/images/folio/guy.jpg" alt="guy" />PORTFOLIO INDIVIDAUAL ITEM IMAGE 
									             	<div class="mask"></div>
									             	<div class="content">
									             ...
									             <li class="view view-first potrait">PORTFOLIO INDIVIDAUAL ITEM  
									             	 <img src="user_info/images/folio/illustration.jpg" alt="illustration" />PORTFOLIO INDIVIDAUAL ITEM IMAGE   
									             	 <div class="mask">  
									             		 <h2>New York</h2>                                   
									             ...
									             <li class="view view-tenth potrait"> PORTFOLIO INDIVIDAUAL ITEM 
									             	<img src="user_info/images/folio/logs.jpg" alt="logs" /> PORTFOLIO INDIVIDAUAL ITEM IMAGE  
									             	<div class="mask">  
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">{{ $user->goods_name }}</h4><!--PORTFOLIO IMAGE TITLE-->
			</div>
			<div class="modal-body">
				<img src="{{ $user->img }}" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
			</div>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="user_info/images/folio/book.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
			</div>
			<div class="modal-footer">
				<div class="mf-content">
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="user_info/images/folio/guy.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
			</div>
			<div class="modal-footer">
				<div class="mf-content">
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="user_info/images/folio/illustration.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
			</div>
			<div class="modal-footer">
				<div class="mf-content">
...
<div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="user_info/images/folio/beach.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
			</div>
			<div class="modal-footer">
				<div class="mf-content">
...
<!--javascript files
=============================================================-->
<script type="text/javascript" src="user_info/js/jQueryTween-aio-min.js"></script> <!-- JQUERY Tween Plugin -->
<script type="text/javascript" src="user_info/js/jquery.tabslet.min.js"></script> <!-- JQUERY Tab plugin-->     
<script type="text/javascript" src="user_info/js/progressbar.min.js"></script> <!-- JQUERY Progressbar Plugin-->
<script type="text/javascript" src="user_info/js/jquery.simple-text-rotator.min.js"></script> <!-- JQUERY Text Rotator-->
<script type="text/javascript" src="user_info/js/bootstrap.min.js"></script> <!-- Bootstrap file-->
<script src="http://ditu.google.cn/maps/api/js?key=AIzaSyBPNkCVoBW_Jzl6x-hgGU6e7QW1QMwKles"></script>
<script type="text/javascript" src='user_info/js/isotope.pkgd.min.js'></script>
<script type="text/javascript" src="user_info/js/custom.js"></script>
</body>
</html>
