...
<html class="x-admin-sm">
  ...
  <body>
    ...
    <div class="x-body">
        <form action="active/doAdd" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="datetime-local" onblur="start_timeSign()" id="start_time" name="start_time" required="" lay-verify="name"
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
          ...
          <div class="layui-form-item layui-form-text">
              ...
              <div class="layui-input-block">
                  <textarea placeholder="请输入内容" onblur="descSign()" id="desc" name="desc" class="layui-textarea"></textarea>
              </div>
          </div>
          <div class="layui-form-item">
